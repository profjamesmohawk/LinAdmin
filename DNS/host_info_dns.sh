...
OUT_FILE=$(hostname)_report_dns.html
...
spit_title "COMP-10018 Host Info Report - DNS"
...
if [ "s01" = $(hostname) ]
then
	spit_start "s01: lookup w01 (2 points)"
	nslookup w01
	spit_end

	spit_start "s01: lookup www.hp.com <strong><em>should fail</em></strong>(2 points)"
	nslookup www.hp.com
	spit_end

	spit_start "s01: lookup 10.1.1.20(2 points)"
	nslookup 10.1.1.20
	spit_end
fi
...
if [ "w01" = $(hostname) ]
then
	spit_start "w01: lookup w01 (2 points)"
	nslookup w01.example.com
	spit_end

	spit_start "w01: lookup www.hp.com (2 points)"
	nslookup www.hp.com
	spit_end
fi
